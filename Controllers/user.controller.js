	...
	create = async (req, res) => {
		...
		//Hvis fejl - send fejlmeddelse
			...
			return res
				.status(418)
				.send(
					"Kunne ikke oprette brugeren. Tjek om du har udfyldt alle felterne korrekt."
				);
		}
	};
	...
	update = async (req, res) => {
		...
		//Hvis fejl - send fejlmeddelse
			...
			return res
				.status(418)
				.send(
					"Kunne ikke opdatere brugeren. Tjek om du har udfyldt alle felterne korrekt."
				);
		}
	};
	...
	delete = async (req, res) => {
		try {
			...
			return res
				.status(418)
				.send(
					"Kunne ikke slette brugeren. Tjek om du har valid id og prøv igen."
				);
		}
	};
}
