...
class UserGroupController {
    ...
    create = async(req, res) => {
        ...
        //Hvis fejl - send fejlmeddelse 
            ...
            return res.status(418).send('Kunne ikke oprette usergroup. Tjek om du har udfyldt alle felterne korrekt.');
        }
    }
    ...
    update = async(req, res) => {
        ...
        //Hvis fejl - send fejlmeddelse 
            ...
            return res.status(418).send('Kunne ikke opdatere usergroup. Tjek om du har udfyldt alle felterne korrekt.');
        }
    }
    ...
    delete = async(req, res) => {
        ...
        //Hvis fejl - send fejlmeddelse 
            ...
            return res.status(418).send('Kunne ikke slette usergroup. Tjek om du har valid id og prøv igen.');
        }
    }
}
